# TrinitySecondEdition System

![Foundry v11](https://img.shields.io/badge/foundry-v11-green)

This system is a trinity-2e system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the TrinitySecondEdition system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-trinity-2e-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `trinity-2e` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `trinity-2e` and `TrinitySecondEdition` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3TrinitySecondEdition System](https://gitlab.com/asacolips-projects/foundry-mods/vue3trinity-2e) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/trinity-2e.png)
